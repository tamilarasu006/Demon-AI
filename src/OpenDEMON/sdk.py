...
class MemoryHandle:
    ...
    def __init__(self, config: DEMONConfig) -> None:
        self._config = config
...
__all__ = ["DEMON", "DEMONSystem", "MemoryHandle", "SystemBuilder"]
