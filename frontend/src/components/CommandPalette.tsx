...
const CLOUD_PROVIDERS: CloudProvider[] = [
  {
    ...
    storageKey: 'opendemon-openai-key',
    models: [
  ...
  },
  {
    ...
    storageKey: 'opendemon-anthropic-key',
    models: [
  ...
  },
  {
    ...
    storageKey: 'opendemon-gemini-key',
    models: [
  ...
  },
  {
    ...
    storageKey: 'opendemon-openrouter-key',
    models: [
      ...
      >
        ...
        >
          {tab === 'installed' ? (
            ...
            <span>API keys are stored locally and never sent to OpenDemon servers</span>
          )}
        </div>
      </div>
    </div>
