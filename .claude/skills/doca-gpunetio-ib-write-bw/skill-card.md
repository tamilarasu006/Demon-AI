...
## Use Case: <br>
Developers and performance engineers measuring sustained RDMA WRITE bandwidth when work requests are posted from a CUDA kernel through doca-gpunetio, on their actual install and GPU-NIC pair. <br>
...
## Evaluation Tasks: <br>
Evaluated against 8 Tier-3 evaluation tasks via the NVSkills-Eval external profile. <br>
