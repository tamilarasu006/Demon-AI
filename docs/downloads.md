---
title: Downloads
description: Download the DEMON desktop app, browser app, CLI, or Python SDK
---
...
!!! info "Backend required"
    ...
    ```bash
    git clone https://github.com/DEMON/DEMON.git && cd DEMON
...
|----------|----------|-------|
| macOS (Universal) | [:material-download: **DEMON.dmg**](https://github.com/DEMON/DEMON/releases/download/desktop-v1.0.2/DEMON_1.0.1_universal.dmg) | Apple Silicon + Intel |
| Windows (64-bit) | [:material-download: **DEMON-setup.exe**](https://github.com/DEMON/DEMON/releases/download/desktop-v1.0.2/DEMON_1.0.1_x64-setup.exe) | Windows 10+ |
| Linux (DEB) | [:material-download: **DEMON.deb**](https://github.com/DEMON/DEMON/releases/download/desktop-v1.0.2/DEMON_1.0.1_amd64.deb) | Ubuntu, Debian |
| Linux (RPM) | [:material-download: **DEMON.rpm**](https://github.com/DEMON/DEMON/releases/download/desktop-v1.0.2/DEMON-1.0.1-1.x86_64.rpm) | Fedora, RHEL |
| Linux (AppImage) | [:material-download: **DEMON.AppImage**](https://github.com/DEMON/DEMON/releases/download/desktop-v1.0.2/DEMON_1.0.1_amd64.AppImage) | Any distro |
...
by Apple. If you see **"DEMON is damaged and can't be opened"**, run this in
