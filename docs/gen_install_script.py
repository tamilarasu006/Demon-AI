...
Serves the installers at::
    ...
    https://DEMON.github.io/DEMON/install.sh   (Linux / macOS / WSL2)
    https://DEMON.github.io/DEMON/install.ps1  (native Windows)

so users have an HTTPS-valid, project-controlled install URL that does not
depend on the externally-hosted ``DEMON.ai`` domain — whose TLS config
