...
class TestGetRustModule:
    ...
    def test_returns_rust_module(self):
        """get_rust_module() returns the DEMON_rust module."""
        ...
        assert result.__name__ == "DEMON_rust"
...
class TestScanResultFromJson:
    ...
    def test_empty_findings(self):
        from OpenDEMON._rust_bridge import scan_result_from_json
...
class TestInjectionResultFromJson:
    ...
    def test_clean(self):
        from OpenDEMON._rust_bridge import injection_result_from_json
...
class TestRetrievalResultsFromJson:
    ...
    def test_empty(self):
        from OpenDEMON._rust_bridge import retrieval_results_from_json
...
class TestRustBackedModules:
    ...
    def test_rate_limiter_uses_rust(self):
        ...
        from OpenDEMON.security.rate_limiter import RateLimiter
