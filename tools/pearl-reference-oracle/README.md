# Pearl reference oracle (DEMON Phase 0 deliverable)
...
If it succeeds, this host can mine Pearl using the DEMON `cpu-pearl` provider
...
- When Pearl bumps `py-pearl-mining` API: re-run the smoke test against the
  new ref pinned in `DEMON/src/DEMON/mining/_constants.py`.
