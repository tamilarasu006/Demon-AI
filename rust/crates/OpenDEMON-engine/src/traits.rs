...
use DEMON_core::{GenerateResult, Message, Role};
use serde_json::Value;
use std::pin::Pin;
use tokio_stream::Stream;

pub type StreamItem = Result<String, DEMON_core::DEMONError>;
...
pub trait InferenceEngine: Send + Sync {
    ...
    fn generate(
        ...
        max_tokens: i64,
        extra: Option<&Value>,
    ) -> Result<GenerateResult, DEMON_core::DEMONError>;
    ...
    async fn stream(
        ...
        max_tokens: i64,
        extra: Option<&Value>,
    ) -> Result<TokenStream, DEMON_core::DEMONError>;

    fn list_models(&self) -> Result<Vec<String>, DEMON_core::DEMONError>;
...
mod tests {
    use super::*;
    use DEMON_core::{Message, ToolCall};
