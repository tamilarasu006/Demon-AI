...
class SkillManager:
    ...
    def _load_overlays(self) -> None:
        ...
        examples under ``manifest.metadata.DEMON.few_shot``.
        ...
        for name, manifest in self._skills.items():
            ...
            if overlay.few_shot:
                ...
                oj = dict(new_metadata.get("DEMON", {}) or {})
                oj["few_shot"] = list(overlay.few_shot)
                new_metadata["DEMON"] = oj
    ...
    def get_few_shot_examples(self) -> List[str]:
        ...
        Pulls from ``manifest.metadata.DEMON.few_shot`` for every
    ...
    def discover_from_traces(
        ...
        *,
        ...
        ``~/.DEMON/skills/discovered/``).  Returns a list of dicts with
    ...
    def _serialize_discovered_skill(name: str, skill: Any) -> str:
        ...
        lines.append('author = "DEMON (auto-discovered)"')
