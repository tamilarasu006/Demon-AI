...
class TestScanResultFromJson:
    ...
    def test_empty_findings(self):
        from DEMON._rust_bridge import scan_result_from_json
...
class TestInjectionResultFromJson:
    ...
    def test_clean(self):
        from DEMON._rust_bridge import injection_result_from_json
...
class TestRetrievalResultsFromJson:
    ...
    def test_empty(self):
        from DEMON._rust_bridge import retrieval_results_from_json
...
class TestRustBackedModules:
    ...
    def test_rate_limiter_uses_rust(self):
        ...
        from DEMON.security.rate_limiter import RateLimiter
