"""ToolTranslator — translate external tool names to DEMON equivalents.

External skill libraries (Hermes Agent, OpenClaw) reference tools by Claude
Code's standard tool names (Bash, Read, Write, etc.).  DEMON uses
...
# ---------------------------------------------------------------------------
# Translation table — external name → DEMON name
# ---------------------------------------------------------------------------
