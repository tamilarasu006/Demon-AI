...
class Recipe:
    ...
    def to_builder_kwargs(self) -> Dict[str, Any]:
        """Convert recipe fields to kwargs for SystemBuilder/DEMON.

        Returns a dict with only the non-None fields, keyed to match
        the SystemBuilder fluent API or DEMON constructor parameters.
        """
        kwargs: Dict[str, Any] = {}
...
def discover_recipes(
    ...
    *,
    ...
    3. User ``~/.DEMON/recipes/`` directory
    4. User ``~/.DEMON/operators/`` directory
