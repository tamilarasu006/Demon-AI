...
Evaluation of the `doca-bench` skill before publication through NVSkills-Eval.
...
- LOW SCHEMA/unexpected_file: Unexpected 'CAPABILITIES.md' in skill root (`skills/tools/doca-bench/CAPABILITIES.md`)
