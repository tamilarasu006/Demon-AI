...
from OpenDEMON.evals.core.event_recorder import AgentEvent, EventType
from OpenDEMON.evals.core.trace import TurnTrace
...
def test_events_to_transcript_tool_call_pair():
    ...
    from OpenDEMON.evals.scorers.pinchbench import events_to_transcript
...
def test_events_to_transcript_tool_name_mapping():
    """DEMON tool names are mapped to PinchBench-expected names."""
    from OpenDEMON.evals.scorers.pinchbench import events_to_transcript
