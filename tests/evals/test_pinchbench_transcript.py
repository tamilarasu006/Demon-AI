...
from DEMON.evals.core.event_recorder import AgentEvent, EventType
from DEMON.evals.core.trace import TurnTrace
...
def test_events_to_transcript_tool_call_pair():
    ...
    from DEMON.evals.scorers.pinchbench import events_to_transcript
