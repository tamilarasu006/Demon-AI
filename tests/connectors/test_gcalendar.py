...
def connector(tmp_path: Path):
    ...
    with patch(
        "DEMON.connectors.oauth._SHARED_GOOGLE_CREDENTIALS_PATH",
...
@patch("DEMON.connectors.gcalendar._gcal_api_calendars_list")
@patch("DEMON.connectors.gcalendar._gcal_api_events_list")
