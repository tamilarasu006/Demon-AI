...
class TestBuildBackendForwardsEndpoint:
    @patch("DEMON.evals.backends.DEMON_direct.DEMONDirectBackend")
    def test_DEMON_direct_receives_base_url_and_api_key(self, mock_cls):
        _build_backend(
            "DEMON-direct",
            "vllm",
            "orchestrator",
    ...
    @patch("DEMON.evals.backends.DEMON_agent.DEMONAgentBackend")
    def test_DEMON_agent_receives_base_url_and_api_key(self, mock_cls):
        _build_backend(
            "DEMON-agent",
            "vllm",
            "orchestrator",
...
class TestTerminalBenchNativeApiBase:
    @patch("DEMON.evals.backends.terminalbench_native.TerminalBenchNativeBackend")
