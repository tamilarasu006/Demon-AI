...
class TestDEMONAgentBackend:
    ...
    def test_construction(self, mock_builder_cls):
        ...
        assert backend.backend_id == "DEMON-agent"
        mock_builder.engine.assert_called_with("cloud")
...
class TestDEMONDirectBackendBaseUrl:
    """--base-url targeting for the DEMON-direct backend."""
    ...
    def test_base_url_injects_pinned_openai_compat_engine(self, mock_builder_cls):
        ...
        with respx.mock:
            ...
            DEMONDirectBackend(base_url="http://127.0.0.1:18999/v1", api_key="sk-x")
    ...
    def test_unreachable_base_url_fails_fast_naming_url(self, mock_builder_cls):
        ...
        with respx.mock:
            ...
            with pytest.raises(RuntimeError, match=r"http://127\.0\.0\.1:18998"):
                DEMONDirectBackend(base_url="http://127.0.0.1:18998")
    ...
    def test_no_base_url_keeps_engine_key_path(self, mock_builder_cls):
        ...
        DEMONDirectBackend(engine_key="vllm")
    ...
    def test_base_url_wins_over_engine_key(self, mock_builder_cls):
        ...
        with respx.mock:
            ...
            DEMONDirectBackend(engine_key="vllm", base_url="http://127.0.0.1:18999")
...
class TestDEMONAgentBackendBaseUrl:
    """--base-url targeting for the DEMON-agent backend."""
    ...
    def test_base_url_injects_pinned_openai_compat_engine(self, mock_builder_cls):
        ...
        with respx.mock:
            ...
            DEMONAgentBackend(base_url="http://127.0.0.1:18999/v1", api_key="sk-x")
    ...
    def test_unreachable_base_url_fails_fast_naming_url(self, mock_builder_cls):
        ...
        with respx.mock:
            ...
            with pytest.raises(RuntimeError, match=r"http://127\.0\.0\.1:18998"):
                DEMONAgentBackend(base_url="http://127.0.0.1:18998")
    ...
    def test_no_base_url_keeps_engine_key_path(self, mock_builder_cls):
        ...
        DEMONAgentBackend(engine_key="vllm")
        mock_builder.engine.assert_called_with("vllm")
        mock_builder.engine_instance.assert_not_called()
