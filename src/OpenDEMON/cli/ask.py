...
def _run_research(
    *,
    ...
    # (so ``DEMON ask --research "..." > out.md`` still gives a clean
...
def ask(
    ...
    # the most common command (`DEMON ask "..."`).
    ...
    if resolved is None:
        console.print(
            ...
            "  [cyan]DEMON config set engine.ollama.host http://<remote-ip>:11434[/cyan]\n"
    ...
    # Privacy guard: a screenshot/image is sensitive, and DEMON is
