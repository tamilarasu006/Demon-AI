...
Why not just use DEMON's :class:`InferenceEngine` for both? Two reasons:
...
class LocalCloudAgent(BaseAgent):
    ...
    def _call_openrouter(
        ...
        *,
        ...
        pass the DEMON-engine-style ``"openrouter/<provider>/<model>"``
        prefix (see ``src/DEMON/engine/cloud.py``) — we strip it here.
