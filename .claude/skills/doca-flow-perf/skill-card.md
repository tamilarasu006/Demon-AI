...
## Use Case: <br>
Developers and platform/network engineers who need a defensible host-side or DPU-CPU-side DOCA Flow rule-install/rule-delete rate measurement using doca_flow_perf, including selecting JSON policies, running iterative eval loops, and capturing reproducibility metadata. <br>
...
- [DOCA Platform (GitHub)](https://github.com/NVIDIA/doca-platform) <br>
...
## Evaluation Tasks: <br>
Evaluated against 8 internal evaluation tasks using NVSkills-Eval Tier 3 profile. <br>
...
| Correctness | 4 | 100% (+66%) | 96% (+61%) |
| Discoverability | 4 | 100% (+65%) | 93% (+60%) |
| Effectiveness | 4 | 97% (+75%) | 97% (+70%) |
| Efficiency | 4 | 92% (+43%) | 89% (+41%) |
