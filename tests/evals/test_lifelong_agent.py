...
class TestDBEnvironment:
    def test_multi_turn_select(self) -> None:
        ...
        from OpenDEMON.evals.environments.lifelong_agent_env import DBEnvironment
...
class TestKGEnvironment:
    def test_multi_turn_with_oracle(self) -> None:
        ...
        from OpenDEMON.evals.environments.lifelong_agent_env import KGEnvironment
...
class TestOSEnvironment:
    def test_requires_docker(self) -> None:
        ...
        from OpenDEMON.evals.environments.lifelong_agent_env import OSEnvironment
