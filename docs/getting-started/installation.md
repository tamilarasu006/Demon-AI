---
title: Installation
description: Get DEMON running — browser app, desktop app, CLI, or Python SDK
search:
  boost: 3
---
...
DEMON runs entirely on your hardware. Choose the interface that fits your workflow.
...
=== "Step 1: Clone and install"
    ...
    uv run maturin develop -m rust/crates/DEMON-python/Cargo.toml
...
The desktop app is a native window for the DEMON chat UI. All inference and backend
...
| Platform | Download |
|----------|----------|
| macOS (Universal) | [:material-download: **DEMON.dmg**](https://github.com/DEMON/DEMON/releases/download/desktop-v1.0.2/DEMON_1.0.1_universal.dmg) |
| Windows (64-bit) | [:material-download: **DEMON-setup.exe**](https://github.com/DEMON/DEMON/releases/download/desktop-v1.0.2/DEMON_1.0.1_x64-setup.exe) |
| Linux (DEB) | [:material-download: **DEMON.deb**](https://github.com/DEMON/DEMON/releases/download/desktop-v1.0.2/DEMON_1.0.1_amd64.deb) |
| Linux (RPM) | [:material-download: **DEMON.rpm**](https://github.com/DEMON/DEMON/releases/download/desktop-v1.0.2/DEMON-1.0.1-1.x86_64.rpm) |
| Linux (AppImage) | [:material-download: **DEMON.AppImage**](https://github.com/DEMON/DEMON/releases/download/desktop-v1.0.2/DEMON_1.0.1_amd64.AppImage) |
...
!!! warning "macOS: \"app is damaged\""
    ...
    ```bash
    xattr -cr /Applications/DEMON.app
    ```
    This is normal for open-source apps distributed outside the App Store.

!!! tip "All releases"
    Browse all versions on the [GitHub Releases](https://github.com/DEMON/DEMON/releases) page.
...
The command-line interface is the fastest way to interact with DEMON
...
DEMON ask --agent orchestrator --tools calculator "What is 137 * 42?"
...
For programmatic access, the `DEMON` class provides a high-level sync API.
...
```python
from DEMON import SystemBuilder
...
DEMON uses optional extras to keep the base installation lightweight.
...
!!! note "Ollama, vLLM, and llama.cpp are HTTP-based"
    These engines have no additional Python dependencies — DEMON communicates over HTTP. You still need the engine software running on your machine.
...
| `server` | `uv sync --extra server` | OpenAI-compatible API server (`DEMON serve`) |
...
DEMON requires at least one inference backend. Choose the one that matches your hardware.
