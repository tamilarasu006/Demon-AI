#!/usr/bin/env python3
"""Index DEMON docs (README.md + docs/**/*.md) into a DenseMemory backend.
...
def build_index(
    ...
    *,
    ...
    dedupe: bool = True,
    # Empirical: on the actual DEMON docs the boilerplate that
    # crowds retrieval ("DEMON runs entirely on your hardware...")
...
def main() -> int:
    ...
    queries = args.query or [
        ...
        "what inference engines does DEMON support?",
