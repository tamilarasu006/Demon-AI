...
# Map the orchestrator's `model` slot to a concrete DEMON worker spec.
...
def _call_tavily_search(
    ...
    Token counts are reported as zero (no LLM was billed); the DEMON
...
_MODAL_APP_NAME = "DEMON-toolorchestra-sandbox"
