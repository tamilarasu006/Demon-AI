...
const GITHUB_BASE =
  'https://github.com/open-demon/OpenDemon/releases/latest/download';
    ...
    <>
      ...
      <div className="flex flex-col gap-3 mb-10">
        <Section icon={Terminal} title="Command Line (macOS / Linux)" defaultOpen>
          ...
          <CodeBlock code={"git clone https://github.com/open-demon/OpenDemon.git\ncd OpenDemon\nuv sync"} />
          <p className="text-xs mt-1" style={{ color: 'var(--color-text-secondary)' }}>
            Then get started:
          </p>
          <CodeBlock code={"DEMON init\nDEMON doctor\nDEMON chat"} />
        </Section>
