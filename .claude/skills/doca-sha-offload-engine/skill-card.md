...
## Use Case: <br>
External developers and operators who have an existing OpenSSL-based pipeline doing SHA hashing and want to offload SHA onto DOCA SHA hardware without rewriting their application against the doca-sha C API. <br>
...
## Evaluation Tasks: <br>
Evaluated against 8 tasks using the NVSkills-Eval external profile in astra-sandbox environment. <br>
...
| Correctness | 4 | 100% (+75%) | 98% (+52%) |
| Discoverability | 4 | 100% (+75%) | 98% (+41%) |
| Effectiveness | 4 | 95% (+78%) | 100% (+74%) |
| Efficiency | 4 | 92% (+48%) | 95% (+32%) |
