...
Single source of truth for every event name and property the DEMON
...
see :mod:`DEMON.analytics.redaction` for the value-level filters.
...
_SPECS: tuple[EventSpec, ...] = (
    ...
    EventSpec(
        ...
        description="`DEMON init` finished and config.toml was written.",
        properties={
