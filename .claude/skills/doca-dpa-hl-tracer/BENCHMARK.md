...
Evaluation of the `doca-dpa-hl-tracer` skill before publication through NVSkills-Eval.
...
- LOW SCHEMA/unexpected_file: Unexpected 'CAPABILITIES.md' in skill root (`skills/tools/doca-dpa-hl-tracer/CAPABILITIES.md`)
