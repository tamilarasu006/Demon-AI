...
# src/DEMON/agents/hybrid/registry/<method>.toml
...
#
# Then run:
#   python -m DEMON.agents.hybrid.runner --cell <printed name>
...
echo "Run with: python -m DEMON.agents.hybrid.runner --cell ${name}"
