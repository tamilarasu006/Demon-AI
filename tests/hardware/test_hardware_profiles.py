...
class TestDetectHardware:
    ...
    @patch("DEMON.core.config.shutil.which", return_value="/usr/bin/nvidia-smi")
    @patch(
        "DEMON.core.config._run_cmd",
    ...
    @patch("DEMON.core.config.shutil.which", return_value="/usr/bin/rocm-smi")
    @patch(
        "DEMON.core.config._run_cmd",
        side_effect=[
    ...
    @patch("DEMON.core.config.platform.system", return_value="Darwin")
    @patch(
        "DEMON.core.config._run_cmd",
        return_value=(
            "Graphics/Displays:\n"
    ...
    @patch("DEMON.core.config.shutil.which", return_value=None)
    @patch("DEMON.core.config.platform.system", return_value="Linux")
