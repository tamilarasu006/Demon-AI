...
class TestRenderBooktabs:
    def test_emits_valid_tabular(self) -> None:
        ...
        assert "hermes" in fragment and "DEMON" in fragment
...
class TestT1Builder:
    def test_t1_builds_from_synthetic_results(self) -> None:
        ...
        assert "DEMON-distilled" in fragment.lower() or "OJ-distilled" in fragment
