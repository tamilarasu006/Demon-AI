...
const CONVERSATIONS_KEY = 'DEMON-conversations';
const SETTINGS_KEY = 'DEMON-settings';
const OPTIN_KEY = 'DEMON-optin';
const OPTIN_NAME_KEY = 'DEMON-display-name';
const OPTIN_EMAIL_KEY = 'DEMON-email';
const OPTIN_ANONID_KEY = 'DEMON-anon-id';
const OPTIN_SEEN_KEY = 'DEMON-optin-seen';
...
interface Settings {
  theme: ThemeMode;
  apiUrl: string;
  // Local server API key (DEMON_API_KEY). Sent as a Bearer token on
  // /v1 + /api requests so a key-protected `DEMON serve` doesn't 401 the
