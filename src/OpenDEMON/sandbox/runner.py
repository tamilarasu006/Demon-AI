...
_OUTPUT_START = "---DEMON_OUTPUT_START---"
_OUTPUT_END = "---DEMON_OUTPUT_END---"
...
class ContainerRunner:
    ...
    ----------
    image:
        Docker image to run.  Defaults to ``DEMON-sandbox:latest``.
    timeout:
    ...
    DEFAULT_IMAGE = "DEMON-sandbox:latest"
    DEFAULT_TIMEOUT = 300
