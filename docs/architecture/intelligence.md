...
```python
from DEMON.intelligence import merge_discovered_models
...
The following names are still importable from `DEMON.intelligence` via shim modules, but their canonical locations have moved:
