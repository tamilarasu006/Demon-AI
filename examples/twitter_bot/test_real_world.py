...
REAL_WORLD_MENTIONS = [
    # === QUESTIONs that should ground (docs cover them) ===
    {
        ...
        "text": (
            "@DEMONAI does this work with vllm or "
    ...
    },
    {
        ...
        "author": "indie_hacker",
        "text": (
            "@DEMONAI can I run the orchestrator agent "
    ...
    },
    {
        ...
        "author": "macuser",
        "text": "@DEMONAI how do I install on macos with apple silicon?",
    },
    {
        "id": "3000000000000000004",
        "author": "longwinded_lou",
        "text": (
            "@DEMONAI how does the memory system handle "
    ...
    # === QUESTIONs that should defer (off-topic / unknowable) ===
    {
        ...
        "text": "@DEMONAI what's the weather in tokyo today?",
    },
    {
        "id": "3000000000000000006",
        "author": "specific_specs",
        "text": (
            "@DEMONAI what's the exact tokens-per-second "
    ...
    # === BUG / FEATURE / PRAISE / SPAM ===
    {
        ...
        "author": "devops_dan",
        "text": (
            "@DEMONAI getting a segfault on startup "
    ...
    },
    {
        ...
        "text": (
            "@DEMONAI any plans for SSO support? "
    ...
    },
    {
        ...
        "author": "convert_carl",
        "text": (
            "@DEMONAI switched from langchain last week, this is incredible"
        ),
    },
    {
        "id": "3000000000000000010",
        "author": "crypto_bro",
        "text": "@DEMONAI BUY $DEMON COIN guaranteed 10x gains link in bio",
    },
]
...
def main():
    ...
    j = DEMON(model=model, engine_key="ollama")
