"""Tests for DEMON.learning.spec_search.models module."""
...
class TestEditPillar:
    ...
    def test_has_four_pillars(self) -> None:
        from OpenDEMON.learning.spec_search.models import EditPillar
...
class TestEditRiskTier:
    ...
    def test_has_three_tiers(self) -> None:
        from OpenDEMON.learning.spec_search.models import EditRiskTier
...
class TestAutonomyMode:
    ...
    def test_three_modes(self) -> None:
        from OpenDEMON.learning.spec_search.models import AutonomyMode
...
class TestSessionStatus:
    ...
    def test_all_statuses(self) -> None:
        from OpenDEMON.learning.spec_search.models import SessionStatus
...
class TestLearningPlan:
    ...
    def test_constructs_with_valid_fields(self) -> None:
        from OpenDEMON.learning.spec_search.models import LearningPlan
...
class TestEditOutcome:
    ...
    def test_applied_outcome(self) -> None:
        from OpenDEMON.learning.spec_search.models import EditOutcome
...
class TestLearningSession:
    ...
    def test_constructs_with_valid_fields(self) -> None:
        from OpenDEMON.learning.spec_search.models import LearningSession
