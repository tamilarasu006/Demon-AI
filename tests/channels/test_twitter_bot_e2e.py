...
class TestClassifyMentionDispatch:
    ...
    def test_valid_labels_pass_through(self, llm_label, expected):
        ...
        assert _classify_mention("some tweet", DEMON=j) == expected
    ...
    def test_defaults_to_question_if_model_returns_other(self):
        ...
        assert _classify_mention("hahaha", DEMON=j) == "QUESTION"
...
# =========================================================================
# 1c. Prompt-injection detector (unit, mocked DEMON)
# =========================================================================
...
class TestPromptBuilders:
    ...
    def test_bug_prompt_contains_github_url(self):
        ...
        assert "api.github.com/repos/DEMON/DEMON/issues" in prompt
...
class TestMentionPolling:
    ...
    def test_poll_dispatches_to_handler(self):
        ...
        assert msg.content == "@DEMONAI how do I install?"
...
class TestEnvVarExpansion:
    ...
    def test_github_token_expanded(self):
        ...
        with (
            ...
            patch(
                "DEMON._rust_bridge.get_rust_module",
                return_value=mock_rust,
            ),
            patch("DEMON.tools.http_request.check_ssrf", return_value=None),
            patch(
                "DEMON.tools.http_request.httpx.request",
...
# =========================================================================
# 5. Full reactive e2e flow (mock DEMON + TwitterChannel)
# =========================================================================
...
class TestFullE2EFlow:
    ...
    def _make_mock_DEMON(self, responses=None):
        """Create a mock DEMON instance that returns canned responses."""
        j = MagicMock()
        if responses:
    ...
    def test_question_flow(self):
        ...
        """
        j = self._make_mock_DEMON(["check the docs at DEMON.github.io"])
        tweet = DEMO_TWEETS[0]
    ...
    def test_bug_report_flow(self):
        ...
        j = self._make_mock_DEMON(["opened an issue for this"])
        tweet = DEMO_TWEETS[1]
    ...
    def test_praise_flow(self):
        ...
        j = self._make_mock_DEMON(["thanks, glad you like it!"])
        tweet = DEMO_TWEETS[3]
        mention_type = "PRAISE"
    ...
    def test_spam_is_ignored(self):
        """Spam mentions should be skipped — no DEMON.ask call."""
        j = self._make_mock_DEMON()
    ...
    def test_all_demo_tweets_processed(self):
        ...
        TestClassifyMentionDispatch against a mocked DEMON. This test
...
class TestGitHubIssueCreation:
    ...
    def test_create_bug_issue(self):
        ...
        mock_resp.text = json.dumps({
            "number": 42,
            "html_url": "https://github.com/DEMON/DEMON/issues/42",
        })
        mock_resp.headers = {"content-type": "application/json"}

        with (
            patch.dict(os.environ, {"GITHUB_TOKEN": "ghp_testtoken123"}),
            patch("DEMON._rust_bridge.get_rust_module", return_value=mock_rust),
            patch("DEMON.tools.http_request.check_ssrf", return_value=None),
            patch(
                "DEMON.tools.http_request.httpx.request",
                return_value=mock_resp,
