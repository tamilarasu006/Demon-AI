...
description: How to add your setup to the DEMON Showcase
---

# Contributing a Showcase Entry

The Showcase exists for one reason: to help a confused, curious, *non-technical* reader figure out whether DEMON is worth their weekend. That goal sets every editorial choice on this page.
...
→ **[Recipe: <name>](https://github.com/DEMON/DEMON/tree/main/src/DEMON/recipes/data)** if you want the exact config.
...
✅ "DEMON answers my Discord messages while I sleep."
...
Hannah and the docs team post merged showcase entries to **`#config-showcase`** in [the DEMON Discord](https://discord.gg/DEMON). You'll get tagged in the post — you don't have to do it yourself.
