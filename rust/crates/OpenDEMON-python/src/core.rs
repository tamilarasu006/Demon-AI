...
impl PyMessage {
    pub fn to_core(&self) -> DEMON_core::Message {
        let role = match self.role.as_str() {
            "system" => DEMON_core::Role::System,
            "assistant" => DEMON_core::Role::Assistant,
            "tool" => DEMON_core::Role::Tool,
            _ => DEMON_core::Role::User,
        };
        DEMON_core::Message {
            role,
...
#[pyclass(name = "Config")]
pub struct PyConfig {
    pub inner: DEMON_core::DEMONConfig,
}
...
impl PyConfig {
    ...
    fn new() -> Self {
        Self {
            inner: DEMON_core::DEMONConfig::default(),
        }
    }
...
pub struct PyEventBus {
    pub inner: std::sync::Arc<DEMON_core::EventBus>,
}
...
impl PyEventBus {
    ...
    fn new() -> Self {
        Self {
            inner: std::sync::Arc::new(DEMON_core::EventBus::new(true)),
        }
    }
