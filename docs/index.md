...
DEMON is a research framework for composable, on-device AI systems.
...
=== "Desktop App"
    ...
    The desktop app is a native window for the DEMON UI.
    ...
    **Step 2.** Download and open the desktop app:
    ...
    [Download for macOS](https://github.com/DEMON/DEMON/releases/download/desktop-v1.0.2/DEMON_1.0.1_universal.dmg){ .md-button .md-button--primary }

    Also available for [Windows](https://github.com/DEMON/DEMON/releases/download/desktop-v1.0.2/DEMON_1.0.1_x64-setup.exe), [Linux (DEB)](https://github.com/DEMON/DEMON/releases/download/desktop-v1.0.2/DEMON_1.0.1_amd64.deb), and [Linux (RPM)](https://github.com/DEMON/DEMON/releases/download/desktop-v1.0.2/DEMON-1.0.1-1.x86_64.rpm). See the [Downloads](downloads.md) page for details.

    The app connects to `http://localhost:8000` automatically.

    !!! warning "macOS first launch"

        Run `xattr -cr /Applications/DEMON.app` if the app shows as "damaged".
...
DEMON is built around five composable layers. Each has a clean interface and can be swapped independently.

1. **Intelligence** — Pick a model, or let DEMON pick one for your hardware. Manages the full catalog of local models across providers.
...
-   **OpenAI-Compatible API**
    ...
    `DEMON serve` starts a FastAPI server with SSE streaming. Drop-in replacement for OpenAI clients.
...
-   **[Getting Started](getting-started/installation.md)**
    ...
    Install DEMON, configure your first engine, and run your first query.
...
-   **[API Reference](api-reference/DEMON/index.md)**
...
Read the [blog post](https://scalingintelligence.stanford.edu/blogs/DEMON/) for the full research motivation, architecture details, and experimental results.
...
Follow [@DEMONAI](https://x.com/DEMONAI) on X for updates.
