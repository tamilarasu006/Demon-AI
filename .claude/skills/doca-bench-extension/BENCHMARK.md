...
Evaluation of the `doca-bench-extension` skill before publication through NVSkills-Eval.
...
- LOW SCHEMA/unexpected_file: Unexpected 'CAPABILITIES.md' in skill root (`skills/tools/doca-bench-extension/CAPABILITIES.md`)
