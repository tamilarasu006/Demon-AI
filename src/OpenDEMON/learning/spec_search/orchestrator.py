...
class SpecSearchOrchestrator:
    ...
    def from_config(
        ...
        *,
        ...
        See ``configs/DEMON/examples/spec-search-quickstart.toml`` for
        the TOML schema and ``examples/DEMON/spec_search_quickstart.py``
