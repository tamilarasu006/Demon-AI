...
class AgenticRunner:
    ...
    async def _run_single_query(
        ...
        # ToolExecutor publishes to DEMONSystem.bus; we relay those into
        ...
        def _run_body() -> None:
            ...
            with ctx:
                ...
                if task_env is not None and hasattr(task_env, "run_agent_loop"):
                    ...
                    if hasattr(agent, "ask"):
                        # SystemBuilder-based agent (DEMONSystem)
        ...
        for turn in turns:
            if turn.cost_usd is None and (
                ...
                from OpenDEMON.evals.core.pricing import compute_turn_cost
