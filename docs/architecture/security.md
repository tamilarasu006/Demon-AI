...
The default path is `~/.DEMON/audit.db`, configurable via `security.audit_log_path` in `config.toml`.
...
- [API Reference: Security](../api-reference/DEMON/security/index.md) — complete class and function signatures
