...
class LLMOptimizer:
    """Uses a cloud LLM to propose optimal DEMON configs.
    ...
    def _build_initial_prompt(self) -> str:
        ...
        lines: List[str] = []
        lines.append("You are optimizing an DEMON AI system configuration.")
        lines.append("")
    ...
    def _build_analyze_prompt(
        ...
        lines: List[str] = []
        lines.append("Analyze this DEMON evaluation result.")
        lines.append("")
