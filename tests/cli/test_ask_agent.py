...
class TestAskAgentOption:
    ...
    def test_no_agent_flag_falls_back_to_config_default_agent(
        ...
        The default ``DEMONConfig`` sets ``default_agent = "simple"``, so
        ``DEMON ask "..."`` should route through SimpleAgent rather than
...
class TestPersonaFilesReachModel:
    ...
    def test_soul_md_content_reaches_engine_in_simple_agent(
        ...
        soul.write_text("PERSONA_SENTINEL_zh_DEMON", encoding="utf-8")
        ...
        assert "PERSONA_SENTINEL_zh_DEMON" in joined
